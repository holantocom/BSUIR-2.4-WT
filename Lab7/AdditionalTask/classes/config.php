...
$auth_conf['email_from'] = "test@test.com"; // Email FROM address for Auth emails (Activation, password reset...)
$auth_conf['max_attempts'] = 5; // INT : Max number of attempts for login before user is locked out
$auth_conf['base_url'] = "https://google.com/"; // URL to Auth Class installation root WITH trailing slash
